...
export default async function handler(req, res) {
  ...
  try {
    ...
    await transporter.sendMail({
      ...
      to: cleanEmail,
      subject: isReset
        ? 'Your Password Reset Code - Tamil Nadu NGO Connect'
        : 'Your Verification Code - Tamil Nadu NGO Connect',
      text: `Your ${isReset ? 'password reset' : 'verification'} code is: ${otp}. It expires in 5 minutes.`,
      html: `
        <div style="max-width: 480px; margin: 0 auto; font-family: Arial, sans-serif; background: #ffffff; border-radius: 12px; overflow: hidden; border: 1px solid #e2e8f0;">
          ...
          <div style="padding: 32px 24px; text-align: center;">
            ...
            <p style="color: #334155; font-size: 15px; margin-bottom: 24px;">Your 6-digit ${isReset ? 'password reset' : 'verification'} code is:</p>
